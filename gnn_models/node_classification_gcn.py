...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="GCN training on coarsened graph, testing on original")
    ...
    model = GCN(g_coarse.ndata["feat"].shape[1], 256, num_classes, args.num_layers).to(device)

    # --- 3. Training ---
    print(f"\nTraining GCN on Coarsened Graph ({args.dataset})...")
