...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_heads", type=int, default=4, help="Number of GAT heads")
    ...
    model = GAT(in_size, 256, out_size, args.num_layers, args.num_heads).to(device)

    if args.dt == "bfloat16":
        g = dgl.to_bfloat16(g)
        model = model.to(dtype=torch.bfloat16)

    print(f"\n--- Training on Original Graph (on {args.mode}) (BASELINE GAT) ---")
